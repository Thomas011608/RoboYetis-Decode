...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1692.312356031488; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -4230.563760346972; // x position of the perpendicular encoder (in tick units)
    }
